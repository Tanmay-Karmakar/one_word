...
def tokenize_queries(args, tokenizer):
    for mode in ["2019", "2020"]:#, "eval.small", "dev", "eval", "train"]:
        query_input = f"{args.msmarco_dir}/trec-dl-{mode}/queries.tsv"
        query_output = f"{args.output_dir}/trec-dl-{mode}-queries.tokenized.json"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", type=str, default="./new_tokenize")
